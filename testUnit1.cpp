...
int w3=wsize3.x;
int h3=wsize3.y;
fegui_resizetextbox(fegui_findwindow("window3"),textbox,w3-20,h3-38);
}
...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
  ...
  fegui_showwindow(window[numwindows]);
  textbox = fegui_createtextbox(window[numwindows]);
  fegui_settextboxid(window[numwindows],textbox,300);
  fegui_settextboxname(window[numwindows],textbox,"textbox1");
  fegui_settextboxpos(window[numwindows],textbox,8,8);
  fegui_resizetextbox(window[numwindows],textbox,300,152);
  fegui_showtextbox(window[numwindows],textbox);
  numwindows++;
